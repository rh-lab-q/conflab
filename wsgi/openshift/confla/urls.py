...
urlpatterns = patterns('',
        ...
        url(r'^rooms/config/save/$', views.RoomConfView.save_config, name='rooms_conf_save'),
        ...
        url(r'^events/popover/admin/$', views.EventView.get_admin_popover, name='eventPop_admin'),
