...
urlpatterns = patterns('',
        ...
        url(r'^rooms/config/$', views.RoomConfView.slot_view, name='conf_rooms'),
        url(r'^rooms/config/save/$', views.RoomConfView.save_config, name='conf_rooms'),
        ...
        url(r'^admin/eventEdit/$', views.EventEditView.event_view, name='editEvent'),
        url(r'^admin/eventEdit/(?P<id>\d+)/$', views.EventEditView.event_view, name='editEvent'),
