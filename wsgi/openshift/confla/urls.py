...
urlpatterns = patterns('',
        ...
        url(r'^(?P<url_id>\w+)/grid/$', views.UserView.speaker_grid, name='speaker_grid'),
        ...
        url(r'^org/admin/import/$', views.ImportView.import_view, name='org_import'),
        url(r'^org/admin/import/oa2015/$', views.ImportView.oa_upload, name='oa_import'),
        url(r'^org/admin/import/json/$', views.ImportView.json_upload, name='json_import'),
