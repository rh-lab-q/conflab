...
urlpatterns = patterns('',
        ...
        url(r'^admin/(?P<url_id>\w+)/eventlist/$', views.EventEditView.event_view, name='editEvent'),
        url(r'^admin/(?P<url_id>\w+)/eventlist/(?P<id>\d+)/$', views.EventEditView.event_view, name='editEvent'),
        url(r'^admin/(?P<url_id>\w+)/eventlist/editEvent/(?P<id>\d+)/$', views.EventEditView.event_save, name='editEvent2'),
